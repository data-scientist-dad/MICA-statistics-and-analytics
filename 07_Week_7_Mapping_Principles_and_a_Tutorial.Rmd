---
title: "Mapping Principles and a Tutorial"
author: "original material from Robin Lovelace"
date: "May 18, 2017"
...
install.packages(z) # warning: uncommenting this may take a number of minutes
...
plot(lnd, col = "bisque") # plot the london_sport object
...
crime_data = read.csv("data/mps-recordedcrime-borough.csv", fileEncoding = "UCS-2LE")
## # names(crime_data)
...
head(crime_theft, 10) # take a look at the result (replace 2 with 10 to see more rows)
